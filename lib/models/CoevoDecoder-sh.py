...
class Pose2Mesh(nn.Module):
    def __init__(self, num_joint, embed_dim=256, SMPL_MEAN_vertiaces=osp.join(BASE_DATA_DIR, 'smpl_mean_vertices.npy')):
    ...
    def forward(self, joints, img_feats, is_train=True, J_regressor=None):
        ...
        inv_mesh2shape = torch.ones((batch_size, 16, 10)).cuda()
