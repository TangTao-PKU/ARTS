...
class Pose2Mesh(nn.Module):
    def __init__(self, num_joint, embed_dim=256, SMPL_MEAN_vertices=osp.join(BASE_DATA_DIR, 'smpl_mean_vertices.npy')):
        ...
        self.trans_feature = Transformer(4, 512, 512*4,length=cfg.DATASET.seqlen)
        self.out_proj = nn.Linear(512, 2048)

        self.prorotation = nn.Linear(24*6, 512)
        self.trans_rotation = Transformer(2, 512, 512*2,length=cfg.DATASET.seqlen)
        self.out_prorotation = nn.Linear(512, 24*6)
        ...
        self.mcsa = Transformer(2, 512, 512*4,length=cfg.DATASET.seqlen)
    ...
    def forward(self, joints, img_feats, is_train=True, J_regressor=None):
        ...
        # img_feats_cross = self.mcsa(img_feats_trans)
        ...
        inv_pred2rot6d = self.prorotation(inv_pred2rot6d)
        inv_pred2rot6d = self.trans_rotation(inv_pred2rot6d)
        inv_pred2rot6d = self.out_prorotation(inv_pred2rot6d)
        ...
        # mesh.export('/data-home/tangt/models/PMCE/output/bone.obj')
